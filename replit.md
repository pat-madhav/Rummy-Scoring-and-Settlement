...
- July 08, 2025: Toned down validation color highlight intensity - Out state (red-600→red-300), Compulsory state (red-200→red-100), Least state (green-200→green-100) for more subtle visual indication