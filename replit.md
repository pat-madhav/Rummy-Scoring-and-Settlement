...
- July 05, 2025: Fixed bottom button overlap with tutorial help button by adding pr-20 right padding to button containers on all pages (welcome, game-options, player-names, scoring, settlement, post-game) to maintain same-level positioning while preventing overlap