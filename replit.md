...
- July 06, 2025: Updated scoring page dropdown position to spawn at bottom corner to the side of score textboxes (left for rightmost players, right for others) to avoid blocking score totals