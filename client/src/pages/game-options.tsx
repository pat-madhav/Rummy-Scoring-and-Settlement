            ...
            <div className="space-y-8">
              ...
              <div className="py-4 border-t border-gray-200 dark:border-gray-700">
                <Collapsible open={advancedSettingsOpen} onOpenChange={setAdvancedSettingsOpen}>
                  ...
                  <CollapsibleContent className="transition-all duration-1000 ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-up-3 data-[state=open]:slide-down-3">
