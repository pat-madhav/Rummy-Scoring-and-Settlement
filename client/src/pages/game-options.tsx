        ...
        <Card>
          <CardContent className="p-6">
            <div className="space-y-8">
              ...
              {/* Advanced Settings */}
              <div className={`${advancedSettingsOpen ? 'pt-4 pb-4' : 'pt-4 pb-0'} border-t border-gray-200 dark:border-gray-700 transition-all duration-300`}>
              ...
              {/* Implied Game Rules */}
              <div className={`${advancedSettingsOpen ? 'pt-4 pb-4' : 'pt-4 pb-4'} border-t border-gray-200 dark:border-gray-700 transition-all duration-300`}>
