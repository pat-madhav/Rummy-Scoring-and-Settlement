...
- July 08, 2025: Added modern score visualization (ScoreDepiction) below scoring table - animated player cards showing Total, Points left, Packs, and Pack Safe with progress bars, smooth animations on round updates, and toggle button in header to show/hide visualization